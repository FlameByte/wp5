 ...
 */
class Daisy_Store_WXR_Parser {
	function parse( $file ) {
		// Attempt to use proper XML parsers first
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new Daisy_Store_WXR_Parser_SimpleXML;
			...
			$parser = new Daisy_Store_WXR_Parser_XML;
			$result = $parser->parse( $file );
		...
		$parser = new Daisy_Store_WXR_Parser_Regex;
 ...
 */
class Daisy_Store_WXR_Parser_SimpleXML {
	function parse( $file ) {
 ...
 */
class Daisy_Store_WXR_Parser_XML {
	var $wp_tags = array(
 ...
 */
class Daisy_Store_WXR_Parser_Regex {
	var $authors = array();
	var $posts = array();
